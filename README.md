...
```
HUBOT_CHATWORK_TOKEN="DEADBEEF"  # see http://developer.chatwork.com/ja/authenticate.html
HUBOT_CHATWORK_ROOMS="123,456"   # comma separated, room that you want bot listen to
HUBOT_CHATWORK_API_RATE="350"    # request per hour
...
# Features
* Auto read comment mention to issue or pull-request to add to your worked list and plan list
* Auto remove from plan list after your pull-request is merged/closed or issue is closed
* Clear problems list after report

# API
```
Hubot problem: {problem} # add problem
Hubot 問題:{problem}
Hubot debug # show data
Hubot scheduler # show pre render report
Hubot send report # send report manually
Hubot remove {group} {content} # remove item from group
Hubot remove {group} {content_id}
Hubot clear # remove all data
```
